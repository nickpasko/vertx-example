...
public class Runner {
  ...
  private static final String MAIN_DIR = "vertx-example";
  private static final String SRC_JAVA_DIR = MAIN_DIR + "/src/main/java/";

  public static void runClusteredExample(Class clazz) {
    runExample(SRC_JAVA_DIR, clazz, new VertxOptions().setClustered(true), null);
  }
